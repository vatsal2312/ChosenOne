...
contract ONE is Context, IERC20, Ownable {
    ...
    string private _name = "CHOSEN ONE";
    ...
    address public marketingWallet = 0xd19FFED1D71e603733f276367C36d582d98Be54c;

    uint256 public _teamFee = 1;
    uint256 private _previousTeamFee = _teamFee;
    address public teamWallet = 0x1Dbf2cD7De062510b19Fdc3c67E97cdc50A8bFD6;
    ...
    constructor() {
        ...
        //exclude owner, marketing, team and this contract from fee
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _marketingFee==0 && _marketingFee==0) return;
    ...
    function setFeePercent(uint256 taxFee, uint256 marketingFee, uint256 teamFee) external onlyOwner() {
        _taxFee = taxFee;
